...
```bash
# wget to download
wget https://dev.mysql.com/get/Downloads/Connector-J/mysql-connector-java_8.0.26-1ubuntu20.04_all.deb -P ~
# dpkg to install
...
Then visit [http://cs179g-fall-2021-0#.cs.ucr.edu:8080/polls](http://cs179g-fall-2021-0#.cs.ucr.edu:8080/polls/) (Replace # with your group number)
